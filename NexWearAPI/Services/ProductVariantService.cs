...
namespace NexWearAPI.Services
{
    ...
    public class ProductVariantService : IProductVariantService
    {
        ...
        public async Task<VariantResponseDto?> UpdateAsync(Guid productId, Guid variantId, UpdateVariantDto dto)
        {
            ...
            if (dto.SalePrice is not null) variant.SalePrice = dto.SalePrice;
        ...
        private static VariantResponseDto MapToDto(ProductVariant v, decimal basePrice) => new()
        {
            ...
            IsActive = v.IsActive,
            IsOnSale = v.IsOnSale,
            // En case de que IsOnSale TRUE
            SalePrice = v.SalePrice,
            DisplayPrice = v.IsOnSale && v.SalePrice.HasValue
                ? v.SalePrice.Value
                : basePrice + v.PriceModifier
        };
    }
}
